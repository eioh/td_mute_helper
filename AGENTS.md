...
## Git �^�p���[���imain ���R�~�b�g�֎~�j
- ����: `main` �� `develop` ����̃}�[�W�̂݁B`main` �Œ��ڃR�~�b�g�E���� push �͂��Ȃ��B
- �����[�g�iGitHub�j�ł̐����ݒ�: �u�����`�ی�ŁuPR �K�{�v�u�ŐV�̏�ԕK�{�iup to date�j�v�u�X�e�[�^�X�`�F�b�N�K�{�v�uforce push �֎~�v��L�����B
- ���[�J���̈��S��i�C�Ӂj:
  - `.git/hooks/pre-commit`�imain ���R�~�b�g�����ہj
    ```bash
    #!/usr/bin/env bash
    branch=$(git rev-parse --abbrev-ref HEAD)
    if [ "$branch" = "main" ]; then
      echo "main ���R�~�b�g�͋֎~�ł��Bdevelop �փR�~�b�g���Ă��������B"
      exit 1
    fi
    ```
  - `.git/hooks/pre-push`�imain �ւ̒��� push �����ہj
    ```bash
    #!/usr/bin/env bash
    while read local_ref local_sha remote_ref remote_sha; do
      if [[ "$remote_ref" =~ refs/heads/main ]]; then
        echo "main �ւ̒��� push �͋֎~�ł��BPR �o�R�Ń}�[�W���Ă��������B"
        exit 1
      fi
    done
    ```
  - ���s����: `chmod +x .git/hooks/pre-commit .git/hooks/pre-push`

## �o�[�W�����^�O�̉^�p
- �X�N���v�g�̃o�[�W�������グ����A�K���^�O���쐬���ă^�O�� push ����B
  - ��ivX.Y.Z �̏ꍇ�j:
    - `git tag -a vX.Y.Z -m "vX.Y.Z"`
    - `git push origin vX.Y.Z`
- �I�v�V����: `npm version patch|minor|major` ���g���� `package.json` �̍X�V�{�^�O�쐬�܂Ŏ������ł���B
