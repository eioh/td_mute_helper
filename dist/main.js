...
(()=>{var tt=Object.defineProperty;var y=(t,e)=>()=>(t&&(e=t(t=0)),e);var T=(t,e)=>{for(var r in e)tt(t,r,{get:e[r],enumerable:!0})};var C={};T(C,{DELAY_BETWEEN_OPERATIONS:()=>D,INITIALIZATION_DELAY:()=>L,VERSION:()=>k});var k,D,L,w=y(()=>{k="0.7.2",D=2e4,L=3e4});function d(t,e){console.error(`[TD Mute Helper] ${t}:`,e),alert(`\u30A8\u30E9\u30FC\u304C\u767A\u751F\u3057\u307E\u3057\u305F: ${t}`)}var v=y(()=>{});var F={};T(F,{getDuplication:()=>at});function at(){try{let t=TD.controller.filterManager.getAll(),e=t.length,r=[];for(let s=0;s<e;s++)for(let l=s+1;l<e;l++)t[s].type==t[l].type&&t[s].value==t[l].value&&r.push(t[s]);return r}catch(t){return d("\u91CD\u8907\u30D5\u30A3\u30EB\u30BF\u30FC\u691C\u7D22\u306B\u5931\u6557\u3057\u307E\u3057\u305F",t),[]}}var P=y(()=>{v()});var K={};T(K,{sleep:()=>nt});var nt,W=y(()=>{nt=t=>new Promise(e=>setTimeout(e,t))});w();var q=`<div id="td-mute-dialog" class="td-dialog-overlay" style="display: none;">\r
  <div class="td-dialog-container">\r
    <div class="td-dialog-header">
      <h3 class="td-dialog-title">\u30DF\u30E5\u30FC\u30C8\u8A2D\u5B9A <span class="td-dialog-title-count"></span></h3>
...
/* \u30BF\u30A4\u30C8\u30EB\u6A2A\u306E\u4EF6\u6570\u8868\u793A */
.td-dialog-container .td-dialog-title-count {
  color: #8b98a5 !important; /* \u8584\u3044\u30B0\u30EC\u30FC */
  font-size: 0.9em !important; /* \u30BF\u30A4\u30C8\u30EB\u3088\u308A\u5C11\u3057\u5C0F\u3055\u3081 */
  margin-left: 8px !important;
}

/* \u30BF\u30D6\u306E\u4EF6\u6570\u8868\u793A */
.td-dialog-container .td-dialog-tab .td-tab-count {
...
\r
`;function B(){let t=document.createElement("div");return t.innerHTML=q,t.firstElementChild}function H(){if(!document.querySelector("style[data-td-dialog]")){let t=document.createElement("style");t.textContent=z,t.setAttribute("data-td-dialog","true"),document.head.appendChild(t)}}function ot(){return new Promise((t,e)=>{let r=document.getElementById("td-mute-dialog");r&&r.remove(),r=B(),document.body.appendChild(r);let s=r.querySelector(".td-dialog-title-count"),l=()=>{var n;try{if(!s)return;let a=((n=TD.controller.filterManager.getAll())==null?void 0:n.length)||0;s.textContent=`(${a}\u4EF6)`}catch(a){console.log(`[TD Mute Helper] \u30D5\u30A3\u30EB\u30BF\u30FC\u4EF6\u6570\u306E\u53D6\u5F97\u306B\u5931\u6557\u3057\u307E\u3057\u305F: ${a.message}`)}};l(),setTimeout(l,200),setTimeout(l,800);try{let n=TD.controller.filterManager.getAll()||[],a={phrase:n.filter(o=>o&&o.type==="phrase").length,regex:n.filter(o=>o&&o.type==="BTD_regex").length,userKeyword:n.filter(o=>o&&o.type==="BTD_mute_user_keyword").length,userRegex:n.filter(o=>o&&o.type==="BTD_user_regex").length,url:n.filter(o=>o&&o.type==="phrase"&&typeof o.value=="string"&&/^https?:\/\//.test(o.value)).length},i=(o,m)=>{let b=r.querySelector(`.td-dialog-tab[data-tab="${o}"]`);if(!b)return;let f=b.querySelector(".td-tab-count");f||(f=document.createElement("span"),f.className="td-tab-count",b.appendChild(f)),f.textContent=`(${m}\u4EF6)`};i("phrase",a.phrase),i("regex",a.regex),i("url",a.url),i("user-keyword",a.userKeyword),i("user-regex",a.userRegex)}catch(n){}let c=r.querySelector(".td-dialog-cancel"),h=r.querySelector(".td-dialog-confirm"),Z=r.querySelector(".td-dialog-close"),U=r.querySelectorAll(".td-dialog-tab"),G=r.querySelectorAll(".tab-content"),p={phrase:r.querySelector("#phrase-input"),regex:r.querySelector("#regex-input"),url:r.querySelector("#url-input"),userKeyword:r.querySelector("#user-keyword-input"),userRegex:r.querySelector("#user-regex-input"),remove:r.querySelector("#remove-input")},u="phrase";U.forEach(n=>{n.addEventListener("click",()=>{let a=n.dataset.tab;u=a,U.forEach(o=>o.classList.remove("active")),n.classList.add("active"),G.forEach(o=>{o.classList.remove("active")}),r.querySelector(`#${a}-tab`).classList.add("active");let i=$();i&&setTimeout(()=>i.focus(),100)})});let $=()=>{switch(u){case"phrase":return p.phrase;case"regex":return p.regex;case"url":return p.url;case"user-keyword":return p.userKeyword;case"user-regex":return p.userRegex;case"remove":return p.remove;default:return null}},I=n=>{try{let a=new URL(n),i=(a.hostname||"").toLowerCase();if(!(i==="twitter.com"||i==="www.twitter.com"||i==="x.com"||i==="www.x.com"))return null;let o=a.pathname.split("/").filter(Boolean);if(o.length===0)return null;let m=o[0];return/^[A-Za-z0-9_]{1,15}$/.test(m)?m:null}catch(a){return null}},J=(n,a)=>{switch(n){case"phrase":case"regex":case"url":case"user-regex":{let m=a.trim();return m===""?!1:/^https?:\/\//i.test(m)&&!I(m)?(alert(`\u7121\u52B9\u306AURL\u3067\u3059\u3002\u6B21\u306E\u5F62\u5F0F\u3067\u5165\u529B\u3057\u3066\u304F\u3060\u3055\u3044:
https://twitter.com/<\u30E6\u30FC\u30B6\u30FC\u540D>/... \u307E\u305F\u306F https://x.com/<\u30E6\u30FC\u30B6\u30FC\u540D>/...`),!1):!0}case"user-keyword":let i=a.trim();if(i===""||!i.includes("|"))return!1;let o=i.split("|");return o.length===2&&o[0].trim()!==""&&o[1].trim()!=="";case"remove":return a.trim()!==""&&!isNaN(Number(a))&&Number(a)>0;default:return!1}},Q=(n,a)=>{let i=a.trim();switch(n){case"phrase":case"url":case"user-keyword":case"user-regex":{if(/^https?:\/\//i.test(i)){let o=I(i);if(o)return o}return i}case"regex":return`/${i}/`;case"remove":return Number(i);default:return i}};r.style.display="flex",setTimeout(()=>p.phrase.focus(),100);let N=()=>{r.remove()},X=()=>{let n=$();if(!n)return;let a=n.value;if(!J(u,a)){n.focus();return}if(N(),u==="remove")t({action:"remove",value:Number(a.trim())});else{let i=Q(u,a);t({action:"add",value:i,type:u})}},x=()=>{N(),e(new Error("User cancelled"))};h.addEventListener("click",X),c.addEventListener("click",x),Z.addEventListener("click",x),Object.values(p).forEach(n=>{n&&n.addEventListener("keydown",a=>{a.key==="Escape"&&x()})}),r.addEventListener("click",n=>{n.target===r&&x()})})}async function O(){console.log("[TD Mute Helper] showMuteDialog called");try{let t=await ot();return console.log("[TD Mute Helper] showCustomDialog resolved with:",t),t}catch(t){throw console.log("[TD Mute Helper] showCustomDialog rejected:",t.message),t}}v();w();v();function g(t,e){try{TD.controller.filterManager.addFilter(t,e)}catch(r){return d(`\u30D5\u30A3\u30EB\u30BF\u30FC\u8FFD\u52A0\u306B\u5931\u6557\u3057\u307E\u3057\u305F (${t}: ${e})`,r),!1}return!0}function j(t){return t.match(/https?:\/\/t\.co\/(.+)/)?"url":t.match(/^\/.+\/$/)?"regex":t.match(/^@@.+/)?"userKeyword":t.match(/^@.+/)?"userRegex":"phrase"}function R(t){try{if(!t||t.trim()==="")throw new Error(`URL\u304C\u7A7A\u3067\u3059\u3002
\u6709\u52B9\u306AURL\u3092\u5165\u529B\u3057\u3066\u304F\u3060\u3055\u3044\u3002
...
\u4F8B: "spamuser|\u5E83\u544A"`);g("BTD_mute_user_keyword",e)}catch(e){throw e.message.includes("\u30E6\u30FC\u30B6\u30FC\u30AD\u30FC\u30EF\u30FC\u30C9\u5F62\u5F0F")?e:new Error(`\u30E6\u30FC\u30B6\u30FC\u30AD\u30FC\u30EF\u30FC\u30C9\u30DF\u30E5\u30FC\u30C8\u306E\u8FFD\u52A0\u306B\u5931\u6557\u3057\u307E\u3057\u305F: ${e.message}`)}}async function S(t){try{let{getDuplication:e}=await Promise.resolve().then(()=>(P(),F)),{sleep:r}=await Promise.resolve().then(()=>(W(),K)),{DELAY_BETWEEN_OPERATIONS:s}=await Promise.resolve().then(()=>(w(),C)),l=e();if(l.length>0)try{TD.controller.filterManager.removeFilter(l[0]),await r(s)}catch(h){d("\u91CD\u8907\u30D5\u30A3\u30EB\u30BF\u30FC\u524A\u9664\u306B\u5931\u6557\u3057\u307E\u3057\u305F",h)}let c;if(t.startsWith("@")?c=t.match(/^@(.+)/)[1]:c=t,!c||c.trim()==="")throw new Error(`\u30E6\u30FC\u30B6\u30FC\u540D\u304C\u7A7A\u3067\u3059\u3002
\u6709\u52B9\u306A\u30E6\u30FC\u30B6\u30FC\u540D\u30D1\u30BF\u30FC\u30F3\u3092\u5165\u529B\u3057\u3066\u304F\u3060\u3055\u3044\u3002
\u4F8B: "spam_.*", "bot[0-9]+"`);try{new RegExp(c)}catch(h){throw new Error(`\u30E6\u30FC\u30B6\u30FC\u540D\u30D1\u30BF\u30FC\u30F3\u304C\u7121\u52B9\u3067\u3059: "${c}"
\u6B63\u3057\u3044\u6B63\u898F\u8868\u73FE\u3092\u5165\u529B\u3057\u3066\u304F\u3060\u3055\u3044\u3002
...
\u4F8B: "\u30B9\u30D1\u30E0", "\u5E83\u544A"`);g("phrase",e)}catch(e){throw e.message.includes("\u30AD\u30FC\u30EF\u30FC\u30C9")?e:new Error(`\u30D5\u30EC\u30FC\u30BA\u30DF\u30E5\u30FC\u30C8\u306E\u8FFD\u52A0\u306B\u5931\u6557\u3057\u307E\u3057\u305F: ${e.message}`)}}async function V(t,e=null){try{if(e)switch(e){case"phrase":E(t);break;case"regex":M(t);break;case"url":R(t);break;case"user-keyword":_(t);break;case"user-regex":await S(t);break;default:E(t);break}else switch(j(t)){case"url":R(t);break;case"regex":M(t);break;case"userKeyword":_(t);break;case"userRegex":await S(t);break;case"phrase":default:E(t);break}return!0}catch(r){return r.message.includes("\u5F62\u5F0F\u304C\u6B63\u3057\u304F\u3042\u308A\u307E\u305B\u3093")||r.message.includes("\u304C\u7A7A\u3067\u3059")||r.message.includes("\u304C\u77ED\u3059\u304E\u307E\u3059")||r.message.includes("\u304C\u7121\u52B9\u3067\u3059")||r.message.includes("\u7121\u52B9\u306AURL\u5F62\u5F0F")||r.message.includes("\u7121\u52B9\u306A\u6B63\u898F\u8868\u73FE")?d("\u5165\u529B\u5F62\u5F0F\u30A8\u30E9\u30FC",r):d(`\u30DF\u30E5\u30FC\u30C8\u30D5\u30A3\u30EB\u30BF\u30FC\u8FFD\u52A0\u51E6\u7406\u3067\u30A8\u30E9\u30FC\u304C\u767A\u751F\u3057\u307E\u3057\u305F: "${t}"`,r),!1}}function A(t){if(!(t<=0))try{var e=TD.controller.filterManager.getAll(),r=e.filter(function(l){return l.type=="phrase"});if(r.length===0){console.log("\u524A\u9664\u5BFE\u8C61\u306E\u30D5\u30A3\u30EB\u30BF\u30FC\u304C\u3042\u308A\u307E\u305B\u3093");return}var s=r[0];console.log(t),console.log(r.length+"/"+e.length),TD.controller.filterManager.removeFilter(s),setTimeout(function(){A(t-1)},2e4)}catch(l){d(`\u30D5\u30A3\u30EB\u30BF\u30FC\u524A\u9664\u306B\u5931\u6557\u3057\u307E\u3057\u305F (\u6B8B\u308A${t}\u500B)`,l)}}function Y(){setTimeout(function(){console.log("loaded"),console.log(`[TD Mute Helper] version ${k} loaded`),H(),document.querySelectorAll(".visible-in-contracted-header").forEach(e=>{e.addEventListener("click",async function(r){console.log("[TD Mute Helper] Click event triggered");try{let s=TD.controller.filterManager.getAll().length;console.log("[TD Mute Helper] Showing unified dialog");let l=await O();console.log("[TD Mute Helper] Dialog result:",l),l.action==="add"&&l.value?await V(l.value,l.type):l.action==="remove"&&l.value&&A(l.value)}catch(s){console.log("[TD Mute Helper] Dialog cancelled or error:",s.message)}}),e.addEventListener("contextmenu",r=>{r.preventDefault()})})},3e4)}(function(){"use strict";Y()})();})();
