...
// ==/UserScript==
(()=>{var V=Object.defineProperty;var h=(t,e)=>()=>(t&&(e=t(t=0)),e);var w=(t,e)=>{for(var r in e)V(t,r,{get:e[r],enumerable:!0})};var U={};w(U,{DELAY_BETWEEN_OPERATIONS:()=>k,INITIALIZATION_DELAY:()=>D,VERSION:()=>E});var E,k,D,b=h(()=>{E="0.5",k=2e4,D=3e4});function d(t,e){console.error(`[TD Mute Helper] ${t}:`,e),alert(`\u30A8\u30E9\u30FC\u304C\u767A\u751F\u3057\u307E\u3057\u305F: ${t}`)}var x=h(()=>{});var z={};w(z,{getDuplication:()=>Z});function Z(){try{let t=TD.controller.filterManager.getAll(),e=t.length,r=[];for(let a=0;a<e;a++)for(let o=a+1;o<e;o++)t[a].type==t[o].type&&t[a].value==t[o].value&&r.push(t[a]);return r}catch(t){return d("\u91CD\u8907\u30D5\u30A3\u30EB\u30BF\u30FC\u691C\u7D22\u306B\u5931\u6557\u3057\u307E\u3057\u305F",t),[]}}var C=h(()=>{x()});var O={};w(O,{sleep:()=>G});var G,P=h(()=>{G=t=>new Promise(e=>setTimeout(e,t))});b();function $(){let t=`
    ...
    `,e=document.createElement("style");e.textContent=t,document.head.appendChild(e)}function _(){let t=`
    ...
    `,e=document.createElement("div");return e.innerHTML=t,e.firstElementChild}function q(){if(!document.querySelector("style[data-td-dialog]")){$();let t=document.querySelector("style:last-of-type");t&&t.setAttribute("data-td-dialog","true")}}function Y(){return new Promise((t,e)=>{let r=document.getElementById("td-mute-dialog");r&&r.remove(),r=_(),document.body.appendChild(r);let a=r.querySelector(".td-dialog-cancel"),o=r.querySelector(".td-dialog-confirm"),s=r.querySelector(".td-dialog-close"),g=r.querySelectorAll(".td-dialog-tab"),W=r.querySelectorAll(".tab-content"),c={phrase:r.querySelector("#phrase-input"),regex:r.querySelector("#regex-input"),url:r.querySelector("#url-input"),userKeyword:r.querySelector("#user-keyword-input"),userRegex:r.querySelector("#user-regex-input"),remove:r.querySelector("#remove-input")},m="phrase";g.forEach(i=>{i.addEventListener("click",()=>{let n=i.dataset.tab;m=n,g.forEach(p=>p.classList.remove("active")),i.classList.add("active"),W.forEach(p=>{p.classList.remove("active")}),r.querySelector(`#${n}-tab`).classList.add("active");let l=A();l&&setTimeout(()=>l.focus(),100)})});let A=()=>{switch(m){case"phrase":return c.phrase;case"regex":return c.regex;case"url":return c.url;case"user-keyword":return c.userKeyword;case"user-regex":return c.userRegex;case"remove":return c.remove;default:return null}},j=(i,n)=>{switch(i){case"phrase":case"regex":case"url":case"user-regex":return n.trim()!=="";case"user-keyword":let l=n.trim();if(l===""||!l.includes("|"))return!1;let p=l.split("|");return p.length===2&&p[0].trim()!==""&&p[1].trim()!=="";case"remove":return n.trim()!==""&&!isNaN(Number(n))&&Number(n)>0;default:return!1}},K=(i,n)=>{let l=n.trim();switch(i){case"phrase":case"url":case"user-keyword":case"user-regex":return l;case"regex":return`/${l}/`;case"remove":return Number(l);default:return l}};r.style.display="flex",setTimeout(()=>c.phrase.focus(),100);let I=()=>{r.remove()},N=()=>{let i=A();if(!i)return;let n=i.value;if(!j(m,n)){i.focus();return}if(I(),m==="remove")t({action:"remove",value:Number(n.trim())});else{let l=K(m,n);t({action:"add",value:l,type:m})}},f=()=>{I(),e(new Error("User cancelled"))};o.addEventListener("click",N),a.addEventListener("click",f),s.addEventListener("click",f),Object.values(c).forEach(i=>{i&&i.addEventListener("keydown",n=>{n.key==="Enter"?N():n.key==="Escape"&&f()})}),r.addEventListener("click",i=>{i.target===r&&f()})})}async function H(){console.log("[TD Mute Helper] showMuteDialog called");try{let t=await Y();return console.log("[TD Mute Helper] showCustomDialog resolved with:",t),t}catch(t){throw console.log("[TD Mute Helper] showCustomDialog rejected:",t.message),t}}x();b();x();function u(t,e){try{TD.controller.filterManager.addFilter(t,e)}catch(r){return d(`\u30D5\u30A3\u30EB\u30BF\u30FC\u8FFD\u52A0\u306B\u5931\u6557\u3057\u307E\u3057\u305F (${t}: ${e})`,r),!1}return!0}function y(t){return t.match(/https?:\/\/t\.co\/(.+)/)?"url":t.match(/^\/.+\/$/)?"regex":t.match(/^@@.+/)?"userKeyword":t.match(/^@.+/)?"userRegex":"phrase"}function T(t){try{if(!t||t.trim()==="")throw new Error(`URL\u304C\u7A7A\u3067\u3059\u3002
\u6709\u52B9\u306AURL\u3092\u5165\u529B\u3057\u3066\u304F\u3060\u3055\u3044\u3002
\u4F8B: "https://example.com"`);try{new URL(t)}catch(r){let a=t.match(/https?:\/\/t\.co\/(.+)/);if(!a||!a[1]||a[1].length===0)throw new Error(`\u7121\u52B9\u306AURL\u5F62\u5F0F\u3067\u3059: "${t}"
\u6B63\u3057\u3044URL\u5F62\u5F0F\u3067\u5165\u529B\u3057\u3066\u304F\u3060\u3055\u3044\u3002
\u4F8B: "https://example.com", "https://t.co/abc123"`)}let e=t.match(/https?:\/\/t\.co\/(.+)/);e&&e[1].length>0?u("phrase",e[1]):u("phrase",t)}catch(e){throw e.message.includes("URL")?e:new Error(`URL\u30DF\u30E5\u30FC\u30C8\u306E\u8FFD\u52A0\u306B\u5931\u6557\u3057\u307E\u3057\u305F: ${e.message}`)}}function L(t){try{let e;if(t.startsWith("/")&&t.endsWith("/")?e=t.match(/^\/(.+)\/$/)[1]:e=t,!e||e.trim()==="")throw new Error(`\u6B63\u898F\u8868\u73FE\u30D1\u30BF\u30FC\u30F3\u304C\u7A7A\u3067\u3059\u3002
\u6709\u52B9\u306A\u30D1\u30BF\u30FC\u30F3\u3092\u5165\u529B\u3057\u3066\u304F\u3060\u3055\u3044\u3002
