...
(()=>{var G=Object.defineProperty;var b=(t,e)=>()=>(t&&(e=t(t=0)),e);var w=(t,e)=>{for(var r in e)G(t,r,{get:e[r],enumerable:!0})};var _={};w(_,{DELAY_BETWEEN_OPERATIONS:()=>k,INITIALIZATION_DELAY:()=>T,VERSION:()=>E});var E,k,T,x=b(()=>{E="0.7.2",k=2e4,T=3e4});function d(t,e){console.error(`[TD Mute Helper] ${t}:`,e),alert(`\u30A8\u30E9\u30FC\u304C\u767A\u751F\u3057\u307E\u3057\u305F: ${t}`)}var y=b(()=>{});var C={};w(C,{getDuplication:()=>tt});function tt(){try{let t=TD.controller.filterManager.getAll(),e=t.length,r=[];for(let i=0;i<e;i++)for(let o=i+1;o<e;o++)t[i].type==t[o].type&&t[i].value==t[o].value&&r.push(t[i]);return r}catch(t){return d("\u91CD\u8907\u30D5\u30A3\u30EB\u30BF\u30FC\u691C\u7D22\u306B\u5931\u6557\u3057\u307E\u3057\u305F",t),[]}}var B=b(()=>{y()});var O={};w(O,{sleep:()=>et});var et,F=b(()=>{et=t=>new Promise(e=>setTimeout(e,t))});x();var N=`<div id="td-mute-dialog" class="td-dialog-overlay" style="display: none;">\r
...
\r
`;var $=`#td-mute-dialog.td-dialog-overlay {\r
...
\r
`;function q(){let t=document.createElement("div");return t.innerHTML=N,t.firstElementChild}function z(){if(!document.querySelector("style[data-td-dialog]")){let t=document.createElement("style");t.textContent=$,t.setAttribute("data-td-dialog","true"),document.head.appendChild(t)}}function X(){return new Promise((t,e)=>{let r=document.getElementById("td-mute-dialog");r&&r.remove(),r=q(),document.body.appendChild(r);let i=r.querySelector(".td-dialog-cancel"),o=r.querySelector(".td-dialog-confirm"),c=r.querySelector(".td-dialog-close"),f=r.querySelectorAll(".td-dialog-tab"),V=r.querySelectorAll(".tab-content"),p={phrase:r.querySelector("#phrase-input"),regex:r.querySelector("#regex-input"),url:r.querySelector("#url-input"),userKeyword:r.querySelector("#user-keyword-input"),userRegex:r.querySelector("#user-regex-input"),remove:r.querySelector("#remove-input")},m="phrase";f.forEach(l=>{l.addEventListener("click",()=>{let a=l.dataset.tab;m=a,f.forEach(s=>s.classList.remove("active")),l.classList.add("active"),V.forEach(s=>{s.classList.remove("active")}),r.querySelector(`#${a}-tab`).classList.add("active");let n=U();n&&setTimeout(()=>n.focus(),100)})});let U=()=>{switch(m){case"phrase":return p.phrase;case"regex":return p.regex;case"url":return p.url;case"user-keyword":return p.userKeyword;case"user-regex":return p.userRegex;case"remove":return p.remove;default:return null}},A=l=>{try{let a=new URL(l),n=(a.hostname||"").toLowerCase();if(!(n==="twitter.com"||n==="www.twitter.com"||n==="x.com"||n==="www.x.com"))return null;let s=a.pathname.split("/").filter(Boolean);if(s.length===0)return null;let u=s[0];return/^[A-Za-z0-9_]{1,15}$/.test(u)?u:null}catch(a){return null}},K=(l,a)=>{switch(l){case"phrase":case"regex":case"url":return a.trim()!=="";case"user-regex":{let u=a.trim();return u===""?!1:/^https?:\/\//i.test(u)&&!A(u)?(alert(`\u7121\u52B9\u306AURL\u3067\u3059\u3002\u6B21\u306E\u5F62\u5F0F\u3067\u5165\u529B\u3057\u3066\u304F\u3060\u3055\u3044:
https://twitter.com/<\u30E6\u30FC\u30B6\u30FC\u540D>/... \u307E\u305F\u306F https://x.com/<\u30E6\u30FC\u30B6\u30FC\u540D>/...`),!1):!0}case"user-keyword":let n=a.trim();if(n===""||!n.includes("|"))return!1;let s=n.split("|");return s.length===2&&s[0].trim()!==""&&s[1].trim()!=="";case"remove":return a.trim()!==""&&!isNaN(Number(a))&&Number(a)>0;default:return!1}},Y=(l,a)=>{let n=a.trim();switch(l){case"phrase":case"url":case"user-keyword":case"user-regex":{if(/^https?:\/\//i.test(n)){let s=A(n);if(s)return s}return n}case"regex":return`/${n}/`;case"remove":return Number(n);default:return n}};r.style.display="flex",setTimeout(()=>p.phrase.focus(),100);let I=()=>{r.remove()},Z=()=>{let l=U();if(!l)return;let a=l.value;if(!K(m,a)){l.focus();return}if(I(),m==="remove")t({action:"remove",value:Number(a.trim())});else{let n=Y(m,a);t({action:"add",value:n,type:m})}},h=()=>{I(),e(new Error("User cancelled"))};o.addEventListener("click",Z),i.addEventListener("click",h),c.addEventListener("click",h),Object.values(p).forEach(l=>{l&&l.addEventListener("keydown",a=>{a.key==="Escape"&&h()})}),r.addEventListener("click",l=>{l.target===r&&h()})})}async function H(){console.log("[TD Mute Helper] showMuteDialog called");try{let t=await X();return console.log("[TD Mute Helper] showCustomDialog resolved with:",t),t}catch(t){throw console.log("[TD Mute Helper] showCustomDialog rejected:",t.message),t}}y();x();y();function g(t,e){try{TD.controller.filterManager.addFilter(t,e)}catch(r){return d(`\u30D5\u30A3\u30EB\u30BF\u30FC\u8FFD\u52A0\u306B\u5931\u6557\u3057\u307E\u3057\u305F (${t}: ${e})`,r),!1}return!0}function P(t){return t.match(/https?:\/\/t\.co\/(.+)/)?"url":t.match(/^\/.+\/$/)?"regex":t.match(/^@@.+/)?"userKeyword":t.match(/^@.+/)?"userRegex":"phrase"}function D(t){try{if(!t||t.trim()==="")throw new Error(`URL\u304C\u7A7A\u3067\u3059\u3002
\u6709\u52B9\u306AURL\u3092\u5165\u529B\u3057\u3066\u304F\u3060\u3055\u3044\u3002
...
\u4F8B: "spamuser|\u5E83\u544A"`);g("BTD_mute_user_keyword",e)}catch(e){throw e.message.includes("\u30E6\u30FC\u30B6\u30FC\u30AD\u30FC\u30EF\u30FC\u30C9\u5F62\u5F0F")?e:new Error(`\u30E6\u30FC\u30B6\u30FC\u30AD\u30FC\u30EF\u30FC\u30C9\u30DF\u30E5\u30FC\u30C8\u306E\u8FFD\u52A0\u306B\u5931\u6557\u3057\u307E\u3057\u305F: ${e.message}`)}}async function M(t){try{let{getDuplication:e}=await Promise.resolve().then(()=>(B(),C)),{sleep:r}=await Promise.resolve().then(()=>(F(),O)),{DELAY_BETWEEN_OPERATIONS:i}=await Promise.resolve().then(()=>(x(),_)),o=e();if(o.length>0)try{TD.controller.filterManager.removeFilter(o[0]),await r(i)}catch(f){d("\u91CD\u8907\u30D5\u30A3\u30EB\u30BF\u30FC\u524A\u9664\u306B\u5931\u6557\u3057\u307E\u3057\u305F",f)}let c;if(t.startsWith("@")?c=t.match(/^@(.+)/)[1]:c=t,!c||c.trim()==="")throw new Error(`\u30E6\u30FC\u30B6\u30FC\u540D\u304C\u7A7A\u3067\u3059\u3002
...
\u4F8B: "\u30B9\u30D1\u30E0", "\u5E83\u544A"`);g("phrase",e)}catch(e){throw e.message.includes("\u30AD\u30FC\u30EF\u30FC\u30C9")?e:new Error(`\u30D5\u30EC\u30FC\u30BA\u30DF\u30E5\u30FC\u30C8\u306E\u8FFD\u52A0\u306B\u5931\u6557\u3057\u307E\u3057\u305F: ${e.message}`)}}async function W(t,e=null){try{if(e)switch(e){case"phrase":v(t);break;case"regex":L(t);break;case"url":D(t);break;case"user-keyword":R(t);break;case"user-regex":await M(t);break;default:v(t);break}else switch(P(t)){case"url":D(t);break;case"regex":L(t);break;case"userKeyword":R(t);break;case"userRegex":await M(t);break;case"phrase":default:v(t);break}return!0}catch(r){return r.message.includes("\u5F62\u5F0F\u304C\u6B63\u3057\u304F\u3042\u308A\u307E\u305B\u3093")||r.message.includes("\u304C\u7A7A\u3067\u3059")||r.message.includes("\u304C\u77ED\u3059\u304E\u307E\u3059")||r.message.includes("\u304C\u7121\u52B9\u3067\u3059")||r.message.includes("\u7121\u52B9\u306AURL\u5F62\u5F0F")||r.message.includes("\u7121\u52B9\u306A\u6B63\u898F\u8868\u73FE")?d("\u5165\u529B\u5F62\u5F0F\u30A8\u30E9\u30FC",r):d(`\u30DF\u30E5\u30FC\u30C8\u30D5\u30A3\u30EB\u30BF\u30FC\u8FFD\u52A0\u51E6\u7406\u3067\u30A8\u30E9\u30FC\u304C\u767A\u751F\u3057\u307E\u3057\u305F: "${t}"`,r),!1}}function S(t){if(!(t<=0))try{var e=TD.controller.filterManager.getAll(),r=e.filter(function(o){return o.type=="phrase"});if(r.length===0){console.log("\u524A\u9664\u5BFE\u8C61\u306E\u30D5\u30A3\u30EB\u30BF\u30FC\u304C\u3042\u308A\u307E\u305B\u3093");return}var i=r[0];console.log(t),console.log(r.length+"/"+e.length),TD.controller.filterManager.removeFilter(i),setTimeout(function(){S(t-1)},2e4)}catch(o){d(`\u30D5\u30A3\u30EB\u30BF\u30FC\u524A\u9664\u306B\u5931\u6557\u3057\u307E\u3057\u305F (\u6B8B\u308A${t}\u500B)`,o)}}function j(){setTimeout(function(){console.log("loaded"),console.log(`[TD Mute Helper] version ${E} loaded`),z(),document.querySelectorAll(".visible-in-contracted-header").forEach(e=>{e.addEventListener("click",async function(r){console.log("[TD Mute Helper] Click event triggered");try{let i=TD.controller.filterManager.getAll().length;console.log("[TD Mute Helper] Showing unified dialog");let o=await H();console.log("[TD Mute Helper] Dialog result:",o),o.action==="add"&&o.value?await W(o.value,o.type):o.action==="remove"&&o.value&&S(o.value)}catch(i){console.log("[TD Mute Helper] Dialog cancelled or error:",i.message)}}),e.addEventListener("contextmenu",r=>{r.preventDefault()})})},3e4)}(function(){"use strict";j()})();})();
