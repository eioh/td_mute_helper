...
(()=>{var Y=Object.defineProperty;var h=(t,e)=>()=>(t&&(e=t(t=0)),e);var v=(t,e)=>{for(var r in e)Y(t,r,{get:e[r],enumerable:!0})};var A={};v(A,{DELAY_BETWEEN_OPERATIONS:()=>E,INITIALIZATION_DELAY:()=>k,VERSION:()=>w});var w,E,k,b=h(()=>{w="0.7.0",E=2e4,k=3e4});function d(t,e){console.error(`[TD Mute Helper] ${t}:`,e),alert(`\u30A8\u30E9\u30FC\u304C\u767A\u751F\u3057\u307E\u3057\u305F: ${t}`)}var x=h(()=>{});var H={};v(H,{getDuplication:()=>Q});function Q(){try{let t=TD.controller.filterManager.getAll(),e=t.length,r=[];for(let a=0;a<e;a++)for(let o=a+1;o<e;o++)t[a].type==t[o].type&&t[a].value==t[o].value&&r.push(t[a]);return r}catch(t){return d("\u91CD\u8907\u30D5\u30A3\u30EB\u30BF\u30FC\u691C\u7D22\u306B\u5931\u6557\u3057\u307E\u3057\u305F",t),[]}}var z=h(()=>{x()});var C={};v(C,{sleep:()=>X});var X,O=h(()=>{X=t=>new Promise(e=>setTimeout(e,t))});b();var _=`<div id="td-mute-dialog" class="td-dialog-overlay" style="display: none;">
