...
// ==/UserScript==
(()=>{var V=Object.defineProperty;var h=(t,e)=>()=>(t&&(e=t(t=0)),e);var w=(t,e)=>{for(var r in e)V(t,r,{get:e[r],enumerable:!0})};var N={};w(N,{DELAY_BETWEEN_OPERATIONS:()=>k,INITIALIZATION_DELAY:()=>D,VERSION:()=>E});var E,k,D,b=h(()=>{E="0.6.0",k=2e4,D=3e4});function d(t,e){console.error(`[TD Mute Helper] ${t}:`,e),alert(`\u30A8\u30E9\u30FC\u304C\u767A\u751F\u3057\u307E\u3057\u305F: ${t}`)}var x=h(()=>{});var H={};w(H,{getDuplication:()=>Z});function Z(){try{let t=TD.controller.filterManager.getAll(),e=t.length,r=[];for(let a=0;a<e;a++)for(let o=a+1;o<e;o++)t[a].type==t[o].type&&t[a].value==t[o].value&&r.push(t[a]);return r}catch(t){return d("\u91CD\u8907\u30D5\u30A3\u30EB\u30BF\u30FC\u691C\u7D22\u306B\u5931\u6557\u3057\u307E\u3057\u305F",t),[]}}var z=h(()=>{x()});var C={};w(C,{sleep:()=>G});var G,O=h(()=>{G=t=>new Promise(e=>setTimeout(e,t))});b();function U(){let t=`
    ...
    `,e=document.createElement("style");e.textContent=t,document.head.appendChild(e)}function $(){let t=`
    ...
    `,e=document.createElement("div");return e.innerHTML=t,e.firstElementChild}function _(){if(!document.querySelector("style[data-td-dialog]")){U();let t=document.querySelector("style:last-of-type");t&&t.setAttribute("data-td-dialog","true")}}function Y(){return new Promise((t,e)=>{let r=document.getElementById("td-mute-dialog");r&&r.remove(),r=$(),document.body.appendChild(r);let a=r.querySelector(".td-dialog-cancel"),o=r.querySelector(".td-dialog-confirm"),s=r.querySelector(".td-dialog-close"),g=r.querySelectorAll(".td-dialog-tab"),F=r.querySelectorAll(".tab-content"),c={phrase:r.querySelector("#phrase-input"),regex:r.querySelector("#regex-input"),url:r.querySelector("#url-input"),userKeyword:r.querySelector("#user-keyword-input"),userRegex:r.querySelector("#user-regex-input"),remove:r.querySelector("#remove-input")},m="phrase";g.forEach(n=>{n.addEventListener("click",()=>{let i=n.dataset.tab;m=i,g.forEach(p=>p.classList.remove("active")),n.classList.add("active"),F.forEach(p=>{p.classList.remove("active")}),r.querySelector(`#${i}-tab`).classList.add("active");let l=A();l&&setTimeout(()=>l.focus(),100)})});let A=()=>{switch(m){case"phrase":return c.phrase;case"regex":return c.regex;case"url":return c.url;case"user-keyword":return c.userKeyword;case"user-regex":return c.userRegex;case"remove":return c.remove;default:return null}},W=(n,i)=>{switch(n){case"phrase":case"regex":case"url":case"user-regex":return i.trim()!=="";case"user-keyword":let l=i.trim();if(l===""||!l.includes("|"))return!1;let p=l.split("|");return p.length===2&&p[0].trim()!==""&&p[1].trim()!=="";case"remove":return i.trim()!==""&&!isNaN(Number(i))&&Number(i)>0;default:return!1}},j=(n,i)=>{let l=i.trim();switch(n){case"phrase":case"url":case"user-keyword":case"user-regex":return l;case"regex":return`/${l}/`;case"remove":return Number(l);default:return l}};r.style.display="flex",setTimeout(()=>c.phrase.focus(),100);let I=()=>{r.remove()},K=()=>{let n=A();if(!n)return;let i=n.value;if(!W(m,i)){n.focus();return}if(I(),m==="remove")t({action:"remove",value:Number(i.trim())});else{let l=j(m,i);t({action:"add",value:l,type:m})}},f=()=>{I(),e(new Error("User cancelled"))};o.addEventListener("click",K),a.addEventListener("click",f),s.addEventListener("click",f),Object.values(c).forEach(n=>{n&&n.addEventListener("keydown",i=>{i.key==="Escape"&&f()})}),r.addEventListener("click",n=>{n.target===r&&f()})})}async function q(){console.log("[TD Mute Helper] showMuteDialog called");try{let t=await Y();return console.log("[TD Mute Helper] showCustomDialog resolved with:",t),t}catch(t){throw console.log("[TD Mute Helper] showCustomDialog rejected:",t.message),t}}x();b();x();function u(t,e){try{TD.controller.filterManager.addFilter(t,e)}catch(r){return d(`\u30D5\u30A3\u30EB\u30BF\u30FC\u8FFD\u52A0\u306B\u5931\u6557\u3057\u307E\u3057\u305F (${t}: ${e})`,r),!1}return!0}function y(t){return t.match(/https?:\/\/t\.co\/(.+)/)?"url":t.match(/^\/.+\/$/)?"regex":t.match(/^@@.+/)?"userKeyword":t.match(/^@.+/)?"userRegex":"phrase"}function T(t){try{if(!t||t.trim()==="")throw new Error(`URL\u304C\u7A7A\u3067\u3059\u3002
\u6709\u52B9\u306AURL\u3092\u5165\u529B\u3057\u3066\u304F\u3060\u3055\u3044\u3002
\u4F8B: "https://example.com"`);try{new URL(t)}catch(r){let a=t.match(/https?:\/\/t\.co\/(.+)/);if(!a||!a[1]||a[1].length===0)throw new Error(`\u7121\u52B9\u306AURL\u5F62\u5F0F\u3067\u3059: "${t}"
\u6B63\u3057\u3044URL\u5F62\u5F0F\u3067\u5165\u529B\u3057\u3066\u304F\u3060\u3055\u3044\u3002
\u4F8B: "https://example.com", "https://t.co/abc123"`)}let e=t.match(/https?:\/\/t\.co\/(.+)/);e&&e[1].length>0?u("phrase",e[1]):u("phrase",t)}catch(e){throw e.message.includes("URL")?e:new Error(`URL\u30DF\u30E5\u30FC\u30C8\u306E\u8FFD\u52A0\u306B\u5931\u6557\u3057\u307E\u3057\u305F: ${e.message}`)}}function L(t){try{let e;if(t.startsWith("/")&&t.endsWith("/")){let r=t.match(/^\/(.*)\/$/);e=r?r[1]:""}else e=t;if(!e||e.trim()==="")throw new Error(`\u6B63\u898F\u8868\u73FE\u30D1\u30BF\u30FC\u30F3\u304C\u7A7A\u3067\u3059\u3002
\u6709\u52B9\u306A\u30D1\u30BF\u30FC\u30F3\u3092\u5165\u529B\u3057\u3066\u304F\u3060\u3055\u3044\u3002
\u4F8B: "RT.*\u30BB\u30FC\u30EB", ".*\u9650\u5B9A.*"`);try{new RegExp(e)}catch(r){throw new Error(`\u6B63\u898F\u8868\u73FE\u30D1\u30BF\u30FC\u30F3\u304C\u7121\u52B9\u3067\u3059: "${e}"
\u6B63\u3057\u3044\u6B63\u898F\u8868\u73FE\u3092\u5165\u529B\u3057\u3066\u304F\u3060\u3055\u3044\u3002
\u4F8B: "RT.*\u30BB\u30FC\u30EB", ".*\u9650\u5B9A.*"`)}u("BTD_regex",e)}catch(e){throw e.message.includes("\u6B63\u898F\u8868\u73FE")?e:new Error(`\u6B63\u898F\u8868\u73FE\u30DF\u30E5\u30FC\u30C8\u306E\u8FFD\u52A0\u306B\u5931\u6557\u3057\u307E\u3057\u305F: ${e.message}`)}}function M(t){try{let e;if(t.startsWith("@@")?e=t.match(/^@@(.+)/)[1]:e=t,!e.includes("|"))throw new Error(`\u30E6\u30FC\u30B6\u30FC\u30AD\u30FC\u30EF\u30FC\u30C9\u5F62\u5F0F\u304C\u6B63\u3057\u304F\u3042\u308A\u307E\u305B\u3093\u3002
\u6B63\u3057\u3044\u5F62\u5F0F: "\u30E6\u30FC\u30B6\u30FC\u540D|\u30AD\u30FC\u30EF\u30FC\u30C9"
\u4F8B: "spamuser|\u5E83\u544A"`);let r=e.split("|");if(r.length!==2||r[0].trim()===""||r[1].trim()==="")throw new Error(`\u30E6\u30FC\u30B6\u30FC\u30AD\u30FC\u30EF\u30FC\u30C9\u5F62\u5F0F\u304C\u6B63\u3057\u304F\u3042\u308A\u307E\u305B\u3093\u3002
\u30E6\u30FC\u30B6\u30FC\u540D\u3068\u30AD\u30FC\u30EF\u30FC\u30C9\u306E\u4E21\u65B9\u3092\u5165\u529B\u3057\u3066\u304F\u3060\u3055\u3044\u3002
\u4F8B: "spamuser|\u5E83\u544A"`);u("BTD_mute_user_keyword",e)}catch(e){throw e.message.includes("\u30E6\u30FC\u30B6\u30FC\u30AD\u30FC\u30EF\u30FC\u30C9\u5F62\u5F0F")?e:new Error(`\u30E6\u30FC\u30B6\u30FC\u30AD\u30FC\u30EF\u30FC\u30C9\u30DF\u30E5\u30FC\u30C8\u306E\u8FFD\u52A0\u306B\u5931\u6557\u3057\u307E\u3057\u305F: ${e.message}`)}}async function R(t){try{let{getDuplication:e}=await Promise.resolve().then(()=>(z(),H)),{sleep:r}=await Promise.resolve().then(()=>(O(),C)),{DELAY_BETWEEN_OPERATIONS:a}=await Promise.resolve().then(()=>(b(),N)),o=e();if(o.length>0)try{TD.controller.filterManager.removeFilter(o[0]),await r(a)}catch(g){d("\u91CD\u8907\u30D5\u30A3\u30EB\u30BF\u30FC\u524A\u9664\u306B\u5931\u6557\u3057\u307E\u3057\u305F",g)}let s;if(t.startsWith("@")?s=t.match(/^@(.+)/)[1]:s=t,!s||s.trim()==="")throw new Error(`\u30E6\u30FC\u30B6\u30FC\u540D\u304C\u7A7A\u3067\u3059\u3002
\u6709\u52B9\u306A\u30E6\u30FC\u30B6\u30FC\u540D\u30D1\u30BF\u30FC\u30F3\u3092\u5165\u529B\u3057\u3066\u304F\u3060\u3055\u3044\u3002
\u4F8B: "spam_.*", "bot[0-9]+"`);try{new RegExp(s)}catch(g){throw new Error(`\u30E6\u30FC\u30B6\u30FC\u540D\u30D1\u30BF\u30FC\u30F3\u304C\u7121\u52B9\u3067\u3059: "${s}"
\u6B63\u3057\u3044\u6B63\u898F\u8868\u73FE\u3092\u5165\u529B\u3057\u3066\u304F\u3060\u3055\u3044\u3002
\u4F8B: "spam_.*", "bot[0-9]+"`)}u("BTD_user_regex",s)}catch(e){throw e.message.includes("\u30E6\u30FC\u30B6\u30FC\u540D")?e:new Error(`\u30E6\u30FC\u30B6\u30FC\u6B63\u898F\u8868\u73FE\u30DF\u30E5\u30FC\u30C8\u306E\u8FFD\u52A0\u306B\u5931\u6557\u3057\u307E\u3057\u305F: ${e.message}`)}}function v(t){try{if(!t||t.trim()==="")throw new Error(`\u30AD\u30FC\u30EF\u30FC\u30C9\u304C\u7A7A\u3067\u3059\u3002
\u6709\u52B9\u306A\u30AD\u30FC\u30EF\u30FC\u30C9\u3092\u5165\u529B\u3057\u3066\u304F\u3060\u3055\u3044\u3002
\u4F8B: "\u30B9\u30D1\u30E0", "\u5E83\u544A"`);let e=t.trim();if(e.length<2)throw new Error(`\u30AD\u30FC\u30EF\u30FC\u30C9\u304C\u77ED\u3059\u304E\u307E\u3059\u3002
2\u6587\u5B57\u4EE5\u4E0A\u306E\u30AD\u30FC\u30EF\u30FC\u30C9\u3092\u5165\u529B\u3057\u3066\u304F\u3060\u3055\u3044\u3002
\u4F8B: "\u30B9\u30D1\u30E0", "\u5E83\u544A"`);u("phrase",e)}catch(e){throw e.message.includes("\u30AD\u30FC\u30EF\u30FC\u30C9")?e:new Error(`\u30D5\u30EC\u30FC\u30BA\u30DF\u30E5\u30FC\u30C8\u306E\u8FFD\u52A0\u306B\u5931\u6557\u3057\u307E\u3057\u305F: ${e.message}`)}}async function P(t,e=null){try{if(e)switch(e){case"phrase":v(t);break;case"regex":L(t);break;case"url":T(t);break;case"user-keyword":M(t);break;case"user-regex":await R(t);break;default:v(t);break}else switch(y(t)){case"url":T(t);break;case"regex":L(t);break;case"userKeyword":M(t);break;case"userRegex":await R(t);break;case"phrase":default:v(t);break}return!0}catch(r){return r.message.includes("\u5F62\u5F0F\u304C\u6B63\u3057\u304F\u3042\u308A\u307E\u305B\u3093")||r.message.includes("\u304C\u7A7A\u3067\u3059")||r.message.includes("\u304C\u77ED\u3059\u304E\u307E\u3059")||r.message.includes("\u304C\u7121\u52B9\u3067\u3059")||r.message.includes("\u7121\u52B9\u306AURL\u5F62\u5F0F")||r.message.includes("\u7121\u52B9\u306A\u6B63\u898F\u8868\u73FE")?d("\u5165\u529B\u5F62\u5F0F\u30A8\u30E9\u30FC",r):d(`\u30DF\u30E5\u30FC\u30C8\u30D5\u30A3\u30EB\u30BF\u30FC\u8FFD\u52A0\u51E6\u7406\u3067\u30A8\u30E9\u30FC\u304C\u767A\u751F\u3057\u307E\u3057\u305F: "${t}"`,r),!1}}function S(t){if(!(t<=0))try{var e=TD.controller.filterManager.getAll(),r=e.filter(function(o){return o.type=="phrase"});if(r.length===0){console.log("\u524A\u9664\u5BFE\u8C61\u306E\u30D5\u30A3\u30EB\u30BF\u30FC\u304C\u3042\u308A\u307E\u305B\u3093");return}var a=r[0];console.log(t),console.log(r.length+"/"+e.length),TD.controller.filterManager.removeFilter(a),setTimeout(function(){S(t-1)},2e4)}catch(o){d(`\u30D5\u30A3\u30EB\u30BF\u30FC\u524A\u9664\u306B\u5931\u6557\u3057\u307E\u3057\u305F (\u6B8B\u308A${t}\u500B)`,o)}}function B(){setTimeout(function(){console.log("loaded"),console.log(`[TD Mute Helper] version ${E} loaded`),_(),document.querySelectorAll(".visible-in-contracted-header").forEach(e=>{e.addEventListener("click",async function(r){console.log("[TD Mute Helper] Click event triggered");try{let a=TD.controller.filterManager.getAll().length;console.log("[TD Mute Helper] Showing unified dialog");let o=await q();console.log("[TD Mute Helper] Dialog result:",o),o.action==="add"&&o.value?await P(o.value,o.type):o.action==="remove"&&o.value&&S(o.value)}catch(a){console.log("[TD Mute Helper] Dialog cancelled or error:",a.message)}}),e.addEventListener("contextmenu",r=>{r.preventDefault()})})},3e4)}(function(){"use strict";B(),typeof module!="undefined"&&module.exports&&(module.exports={detectMutePattern:y})})();})();
